        ...
        <div>
          <Link href="/">
            <h1 className="font-Inter text-3xl cursor-pointer">
              <span className="text-[#64ff4c]">AiI</span>mage
            </h1>
          </Link>
        </div>
        <div className="flex">
      ...
      <div className="w-full md:hidden flex items-center justify-between">
        ...
        {open && (
          <div
            ...
            id="screen"
          >
            <div className="fixed flex flex-col bg-black h-screen top-0 right-0 w-[60%] z-[9999]">
              <div className="mt-20 p-5 flex flex-col">
                <Navigation activeItem={activeItem} />
              </div>
            </div>
          </div>
